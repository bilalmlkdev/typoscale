...
import { ChevronLeft, ChevronRight, Type, Sliders } from "lucide-react";
  ...
  const sidebarContent = (
    <>
            ...
            <>
              ...
              <div className="space-y-5">
                ...
                <div>
                  ...
                  >
                    {Object.entries(SCALE_RATIOS).map(
                      ([key, { label, value }]) => (
      ...
      <div
        ...
        } ${isCollapsed && !isMobile ? "p-2" : "px-5 py-3"}`}
      >
        <div
          className={`text-[10px] text-center ${darkMode ? "text-stone-600" : "text-stone-400"}`}
        >
          {isCollapsed && !isMobile ? "" : "typoscale v1.0"}
        </div>
      </div>
    </>
  );
